            ...
            <div>
              ...
              <h1 className="mb-6 text-5xl font-bold leading-tight text-slate-950 md:text-6xl">
                ...
                <span className="block text-emerald-700">
                  in one clean operating layer.
                </span>
              </h1>
              <p className="mb-10 max-w-2xl text-lg leading-relaxed text-slate-600">
                GreenAI helps SMEs map obligations from NACE, automate CSRD
                workflows, and ship audit-ready outputs faster than traditional
                consulting cycles.
              </p>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  { label: "Report outputs", value: "PDF / DOCX / ESRS" },
                ].map((stat) => (
                  <div
                    key={stat.label}
                    className="rounded-xl border border-white/70 bg-white/70 px-4 py-4 shadow-sm"
                  >
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-2xl border border-emerald-100 bg-white p-4">
                    ...
                    <p className="text-sm text-slate-600">
                      From your business profile to obligations in minutes.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-cyan-100 bg-white p-4">
                    ...
                    <p className="text-sm text-slate-600">
                      Scope 1-3 guidance with practical next actions.
                    </p>
                  </div>
                </div>
                <div className="rounded-2xl border border-white/70 bg-white/85 p-4">
                  <p className="text-sm text-slate-700">
                    Designed to replace fragmented spreadsheets and ad-hoc
                    consulting with a repeatable workflow your whole team can
                    trust.
                  </p>
                </div>
              </div>
          ...
          <div className="mb-12 flex items-end justify-between gap-6">
            <div>
              <h2 className="text-4xl font-bold text-slate-950">
                Products that fit real operations
              </h2>
              <p className="mt-3 max-w-2xl text-slate-600">
                Start with a single tool or combine all modules for one
                connected sustainability stack.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <article className="rounded-3xl border border-white/80 bg-white/80 p-7 shadow-lg shadow-slate-900/5">
              ...
              <h3 className="mt-2 text-2xl font-bold text-slate-950">
                {products.compliance.name}
              </h3>
              <p className="mt-3 text-sm text-slate-600">
                {products.compliance.subtitle}
              </p>
              <ul className="mt-6 space-y-3">
                {[
                  "Country + NACE-based regulation detection",
                  "Automated task scheduling & monthly calendar",
                  "Knowledge hub with explainer articles",
                ].map((item) => (
                  <li
                    key={item}
            ...
            <article className="relative overflow-hidden rounded-3xl border border-emerald-300 bg-gradient-to-br from-emerald-100 via-teal-100 to-cyan-100 p-7 shadow-lg shadow-emerald-900/10">
              ...
              <div className="relative">
                ...
                <h3 className="mt-2 text-2xl font-bold text-slate-950">
                  {products.opensource.name}
                </h3>
                <p className="mt-3 text-sm text-slate-700">
                  {products.opensource.description}
                </p>
                <div className="mt-7 flex flex-wrap gap-3">
                  <a
                    href="https://github.com/GreenAI-Analytics/os-for-work/archive/refs/tags/v1.3.2.zip"
        ...
        <div className="section-shell">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-3xl text-slate-600">
              From AI enablement to ESG reporting, we combine software with
              delivery support to help your team move with confidence.
            </p>
          </div>
        ...
        <div className="section-shell">
          <div className="mb-12 text-center">
            ...
            <p className="mt-3 text-slate-600">
              Start free where possible and scale to managed support when
              needed.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-slate-950 px-8 py-14 text-center text-white md:px-12">
            ...
            <div className="relative">
              <h2 className="text-4xl font-bold">
                Ready to modernize your reporting stack?
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-slate-300">
                Talk to GreenAI and get a practical rollout plan tailored to
                your sector, NACE code, and reporting goals.
              </p>
